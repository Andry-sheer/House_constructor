...
export function getUpdatedLayer(
  ...
  if (layerKey === "wall") {
    ...
    if (layerFilters.wall === "singleton1") {
      path = "/assets/images/walls/layers-singletone/w-singletone2.png";
    } else if (layerFilters.wall === "singleton2") {
      path = "/assets/images/walls/layers-singletone/w-singletone.png";
    ...
    if (layerFilters.wall === "marble1") {
      path = "/assets/images/walls/layers-marble/w-marble.png";
    } else if (layerFilters.wall === "marble2") {
      path = "/assets/images/walls/layers-marble/w-marble.png";
    } else if (layerFilters.wall === "marble3") {
      path = "/assets/images/walls/layers-marble/w-marble.png";
    } else if (layerFilters.wall === "marble4") {
      path = "/assets/images/walls/layers-marble/w-marble2.png";
  ...
  if (layerKey === "angles") {
    ...
    if (layerFilters.angles === "singleton1") {
      path = "/assets/images/angles/layers-singletone/c-singletone2.png";
    } else if (layerFilters.angles === "singleton2") {
      path = "/assets/images/angles/layers-singletone/c-singletone.png";
    ...
    if (layerFilters.angles === "marble1") {
      path = "/assets/images/angles/layers-marble/c-marble.png";
    } else if (layerFilters.angles === "marble2") {
      path = "/assets/images/angles/layers-marble/c-marble.png";
    } else if (layerFilters.angles === "marble3") {
      path = "/assets/images/angles/layers-marble/c-marble.png";
    } else if (layerFilters.angles === "marble4") {
      path = "/assets/images/angles/layers-marble/c-marble2.png";
  ...
  if (layerKey === "corner") {
    ...
    if (layerFilters.corner === "singleton1") {
      path = "/assets/images/basement/layers-singletone/b-singletone2.png";
    } else if (layerFilters.corner === "singleton2") {
      path = "/assets/images/basement/layers-singletone/b-singletone.png";
    ...
    if (layerFilters.corner === "marble1") {
      path = "/assets/images/basement/layers-marble/b-marble.png";
    } else if (layerFilters.corner === "marble2") {
      path = "/assets/images/basement/layers-marble/b-marble.png";
    } else if (layerFilters.corner === "marble3") {
      path = "/assets/images/basement/layers-marble/b-marble.png";
    } else if (layerFilters.corner === "marble4") {
      path = "/assets/images/basement/layers-marble/b-marble2.png";
